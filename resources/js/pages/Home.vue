            ...
            <header
                ...
                <nav class="flex items-center justify-end gap-4">
                    <Link v-if="$page.props.auth.user" :href="route('dashboard')"
                        class="inline-block rounded-md border border-secondary px-5 py-1.5 text-sm leading-normal text-black hover:border-primary dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-primary">
                    Dashboard
                    </Link>
                    <template v-else>
            ...
            <div
                ...
                <main
                    ...
                    <div class="w-1/2 flex flex-col justify-center items-start gap-6">
                        <p class="font-black text-4xl max-w-xl dark:text-white">Bingung cari tempat kuliah?

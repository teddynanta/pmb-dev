...
<template>
    <div class="flex items-center justify-between px-2">
        ...
        <div class="flex items-center space-x-6 lg:space-x-8">
            ...
            <div class="flex items-center space-x-2">
                <Button variant="outline" class="hidden cursor-pointer w-8 h-8 p-0 lg:flex"
                    :disabled="!table.getCanPreviousPage()" @click="table.setPageIndex(0)">
                    <span class="sr-only">Go to first page</span>
                    <ChevronsLeft class="h-4 w-4" />
                </Button>
                <Button variant="outline" class="cursor-pointer w-8 h-8 p-0" :disabled="!table.getCanPreviousPage()"
                    @click="table.previousPage()">
                    <span class="sr-only">Go to previous page</span>
                    <ChevronLeft class="w-4 h-4" />
                </Button>
                <Button variant="outline" class="cursor-pointer w-8 h-8 p-0" :disabled="!table.getCanNextPage()"
